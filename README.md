# assistente juridico github pages (1) — Projeto Android (Capacitor)

## Origem
Arquivo: assistente-juridico-github-pages (1).zip (21 arquivos)
...
## Configuração
- **Package:** `com.meuapp.assistentejuridicogithubpages1`
- **Versão:** 3.1.2 (code: 3)
- **Min SDK:** Android 24+
- **Orientação:** any
